...
internal class PartnerInfoDetailChannel @Inject constructor(): PartnerInfoDetailChannelApi {
    ...
    private val fragmentChannel: Relay<ActivityLifecycleState> = PublishRelay.create()
    ...
    override fun ofLifeCycle(): Observable<ActivityLifecycleState>            = fragmentChannel
    ...
    override fun accept(lifecycle: ActivityLifecycleState)            = fragmentChannel.accept(lifecycle)
